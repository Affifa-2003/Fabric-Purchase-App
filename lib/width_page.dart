                                  ...
                                  onTap: () {
                                    ...
                                    if (isProductActive) {
                                      ...
                                      ScaffoldMessenger.of(
                                        ...
                                        const SnackBar(
                                          content: Text(
                                            'Cannot edit width for inactive product',
                                          ),
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: !isProductActive
              ? Text(
                  'This width belongs to an inactive product "${width['product']}" and cannot be deleted.',
                )
              : isMapped
              ? const Text(
                  'This width is already mapped with orders and cannot be deleted.',
                )
              : Text(
                  'Are you sure you want to delete "${width['product']} - $widthValue inches"?',
                ),
          actions: [
            TextButton(
              onPressed: () {
