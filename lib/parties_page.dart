    ...
    showDialog(
      ...
      builder: (context) {
        return AddPartyDialog(
          ...
          transports: transports, // Add this
        );
      },
    ).then((result) {
      if (result != null) {
        ...
        PartyService()
            ...
            .catchError((error) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Error updating party: $error'),
                  backgroundColor: Colors.red,
                ),
              );
            });
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Card(
                                ...
                                // In the ListTile of the ListView.builder, update the leading and title widgets:
                                child: ListTile(
                                  ...
                                  title: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      fontSize: 16,
                                      // Remove the conditional color - always use black
                                      color: Colors.black,
                                    ),
                                  ),
                                  trailing: IconButton(
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            if (!isMapped)
              TextButton(
                onPressed: () async {
                  // Delete the party using the service
                  PartyService()
