...
import 'package:purchase_app/Modules/Purchase/features/pages/transactions/party_details_page.dart';
import 'dart:convert';
import 'package:hive_flutter/hive_flutter.dart';
import 'package:purchase_app/Modules/Purchase/features/services/order_service.dart';
...
class _PurchaseListPageState extends State<PurchaseListPage> {
  ...
  final Color primaryColor = const Color(
    0xFF2563EB,
  ); // Use the same color as HomePage
        ...
        actions: [
          Container(
            ...
            child: IconButton(
              ...
              onPressed: () {
                AppRoutes.navigateTo(context, AppRoutes.newOrderSetup);
              },
            ),
          ),
        ],
